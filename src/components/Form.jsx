...
const Form = () => {
    ...
    return (
        <div style={{ backgroundColor: '#000', minHeight: '80vh',width:'1000px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <div className="login-box">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="comment" style={{marginBottom:'5px'}}>
                            ...
                            <textarea name="comment" style={{textAlign:'start',borderRadius:'8px'}} cols={65} rows={6} onChange={(e) => handleInput(e)}></textarea>
                        </div>
